...
working_directory = "/Users/sanjay/projects"

# ✅ This should work (inside directory, exists)
print(get_files_info(working_directory, "/Users/sanjay/projects/myapp"))

# ❌ This should return an "outside working directory" error
print(get_files_info(working_directory, "/Users/sanjay/Desktop"))

# ❌ This should return a "not a directory" error (assuming it's a file)
print(get_files_info(working_directory, "/Users/sanjay/projects/myapp/README.md"))

# ❌ This should return a "no directory provided" error
